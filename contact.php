...
<html>
	...
	<body> 
		...
		<div style="margin-top: 5%;width: 30%;margin-left: 20%;float:left;">
					...
					<b style="font-size: 1vw;font-weight: 500;font-family: sans-serif;">PHONE: 012-3456789</b> <br> <br>

					<b style="font-size: 1vw;font-weight: 500;font-family: sans-serif;">FAX: 012-345566778</b> <br> <br>

					<b style="font-size: 1vw;font-weight: 500;font-family: sans-serif;">KITCHEN: 012-345666778</b>
		...
		<div style="margin-top: 5%;width: 30%;float:left;">
					...
					Lacated at <br>
					36A, Jalan 4/91, Taman Shamelin Perkasa, 56100 Kuala Lumpur, Wilayah Persekutuan Kuala Lumpur
				</div>

					<div>
			<script src='https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyBlCj_wVYbTdVth-18nNPPecFspHZNrLK0'></script><div style='overflow:hidden;height:350px;width:750px;'><div id='gmap_canvas' style='height:350px;width:750px;'></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style></div> <a href='https://www.embedmap.net/'>embed google maps in website</a> <script type='text/javascript' src='https://embedmaps.com/google-maps-authorization/script.js?id=f7f7d9de67a9d9c6d9d83749715a0e985f91b5b9'></script><script type='text/javascript'>function init_map(){var myOptions = {zoom:12,center:new google.maps.LatLng(3.1667,101.70000000000005),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById('gmap_canvas'), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(3.1667,101.70000000000005)});infowindow = new google.maps.InfoWindow({content:'<strong>OrderIt</strong><br>36A, Jalan 4/91, Taman Shamelin Perkasa<br>56100 Kuala Lumpur<br>'});google.maps.event.addListener(marker, 'click', function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
				</div>
