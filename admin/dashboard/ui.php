...
<html>
	...
	<body>
        ...
        <div class="header">
                        <div class="left">
                            <i class="fa fa-spoon"></i><i class="fa fa-spoon"></i> OrderIT
                        </div>
                        <div class="left2">
    	...
    	<div class="content">
            ...
            <div class="product-container">
                <div class="item">
                    ...
                    <p class="name">OrderIt <kbd style="background-color:#e74c3c;">P12</kbd></p>
        ...
        <!-- Start of footer-->
        <div class="footer">
            Copyright &copy 2019 - OrderIT Admin Dashboard
        </div>
        <!-- End of footer-->
...
<div class="add_products animated bounce">
		...
		<div class="form-cont">
				...
				<select name="">
						<option value="OrderIt">OrderIt</option>
